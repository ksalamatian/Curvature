...
import numpy as np
G=nx.read_graphml("/Users/ksalamatian/CLionProjects/NewCurvature/processed/processed.12.graphml")
...
for u,v,d in G.edges(data=True):
    rdistMat[(G.nodes[u]["block"],G.nodes[v]["block"])].append(d["distance"])
